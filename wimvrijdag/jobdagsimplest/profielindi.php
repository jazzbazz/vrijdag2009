...
<body>
    ...
    <main class="container flexd2">
        <p class="intro">
            <h3>Hello <?php echo $voornaam." ,Welkom op je profiel"?>.</h3>
        </p>
        <div class="imgoutput">
<?php
echo "<div class='card-header'><h4>".$voornaam."</h4>";
         echo "<h4>".$naam."</h4></div>";
         echo "<div class='imagefit'><img src='".$path."' alt='".$id."'></div>";
         echo "<div class='omschrijf'><p>".$omschrijving."</p></div>";
         if($fbend === "both"){
            echo "<div class='siri'>Uw hart gaat sneller slaan van zowel Front End als Back End.</div>";
         } else {
            echo "<div class='siri'>Uw hart gaat sneller slaan van ".$fbend."</div>";
         }
         echo "<div class='skills'>Uw sterkste punten zijn ".$skill1.", ".$skill2." en ".$skill3.".</div>";
         echo "<div class='antwoorden'><p> U koos om volgende reden voor webdevolopment : ".$waarom."</p><p> U zoekt volgende zaken in een bedrijf : ".$wat."</p><p> Volgende waardes vindt u belangrijk : ".$waarde."</p></div>";
